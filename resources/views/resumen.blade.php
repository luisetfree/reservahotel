...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
  ...
  <body class="bg-light">
    ...
    <div class="container col-md-8 col-md-offset-2">
          <h2 align="center">Resumen de su reservación</h2><br>
    
        <div class="panel panel-default ">
            <h4 class="alert alert-primary">Información personal</h4>
            <div class="panel-heading px-4 alert alert-secondary">
            ...
            @else
              ...
              <h4 class="alert alert-primary">Información de reserva</h4> 
              <div class="px-4 alert alert-secondary" >
